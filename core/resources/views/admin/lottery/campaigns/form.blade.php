<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <form action="{{ isset($campaign) ? route('admin.lottery.campaigns.update', $campaign->id) : route('admin.lottery.campaigns.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
