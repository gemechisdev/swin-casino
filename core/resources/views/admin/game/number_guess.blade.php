        ...
        <div class="col-lg-6">
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.game.chance.create', 'number_guess') }}" method="post"
                        class="d-none levelForm">
                        @csrf
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-6">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <h5 class="mb-3">@lang('Invest Amount Setting')</h5>
                        <div class="form-group">
                            <label>@lang('Minimum Invest Amount')</label>
                            <div class="input-group">
                                <input class="form-control" name="min" type="number" step="any"
                                    value="{{ getAmount($game->min_limit) }}" min="1"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input class="form-control" name="max" type="number" step="any"
                                    value="{{ getAmount($game->max_limit) }}" min="1"
